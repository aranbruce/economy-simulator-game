...
export function DiploHud() {
  ...
  return (
    <div
      id="diploHud"
      className={`diplo-hud hud-frame hud-surface fixed left-1/2 z-15 flex max-w-[min(96vw,720px)] -translate-x-1/2 cursor-pointer flex-wrap items-center justify-center gap-1.5 px-3 py-1.5 text-[11.5px] leading-[1.35] tabular-nums transition-[filter,transform] duration-160 hover:brightness-[1.08] active:scale-[0.98] max-md:max-w-[calc(100vw-12px)] ${
        belowMp
