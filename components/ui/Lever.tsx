...
export function Lever({
  ...
  return (
    <div className="py-2 px-3 border-b border-edge last:border-b-0" data-lever={id}>
      <div className="flex items-baseline gap-2 text-[13px]">
        ...
        <span className={`text-[11px] w-[42px] text-right font-semibold ${chgColor || "text-ink-faint"}`}>
          {delta}
        </span>
      </div>
      <input
