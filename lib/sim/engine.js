...
function briefingHtml(brief, opts) {
    ...
    if (impact && (impact.quiet || impact.economic || impact.approval || impact.politics)) {
        ...
        if (impact.quiet) {
            ...
            if (impact.economic) {
                h += '<section class="briefing-impact briefing-impact--econ"><div class="briefing-label">Economic changes</div><p class="briefing-impact-line">' + esc(impact.economic) + '</p></section>';
            }
            if (impact.approval || impact.politics) {
                h += '<section class="briefing-impact briefing-impact--approval"><div class="briefing-label">Approval</div>';
