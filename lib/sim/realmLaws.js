...
export const REALM_LAW = {
  /* Gaul Republic (France): standard VAT ~21%, social protection heavy, defence near NATO
  ...
  /* Northern Reach (Russia): mineral/windfall state, elevated defence, flat-ish
  ...
  /* Atlantic Federation (Brazil): VAT-heavy (~19), middling welfare, cannabis
