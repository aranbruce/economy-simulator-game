...
export const REALM_LAW = {
  /* Gaul Republic (France): standard VAT ~21%, the OECD's heaviest social
  ...
  /* Green Coast Republic (Nigeria): thinner welfare state, higher tariffs, commodity windfall,
  ...
  /* Atlantic Federation (Brazil): VAT-heavy (~19), pension-heavy welfare
     (RGPS + RPPS alone run near 12% of GDP), corp at the IRPJ + CSLL 34%,
     cannabis decriminalised patchwork, social housing push. */
  brazil: {
    tariff: 6,
    spend: {
      health: 5.2,
