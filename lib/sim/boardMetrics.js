...
import { metricRampCss, METRIC_MISSING } from "./metricRamp.js";
...
export function boardMetricValueLabel(role, metric, G = getG()) {
...
export function boardMetricMapLabel(role, metric, displayName, G = getG()) {
