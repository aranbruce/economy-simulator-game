...
/** Group seat ids by ISO currency code. */ export function currencyAreas(seatIds) {
  const areas = {};
 ...
 * @param {object} bags - { [id]: { econ } } including player mirrored bag
 * @param {string[]} seatIds
 * @param {object} [opts] - { playerId, playerEcon } so player rate can lead their area
 */
export function stepCurrencyAreas(bags, seatIds, opts) {
  const o = opts || {};
